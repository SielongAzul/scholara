          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <td> -- </td>
                <td>May 3, 2024</td>
                <td class="d-flex"> <button type="button" class="btn btn-secondary btn-sm">Validate Scholarship</button> <button type="button" class="btn btn-primary btn-sm">View Detail</button> <button type="button" class="btn btn-danger btn-sm">Delete</button></td>
              </tr>
